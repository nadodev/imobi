...
@section('title', 'Criar Página Sobre')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Criar Página Sobre</h1>
    ...
    <!-- Form -->
    <form action="{{ route('admin.pagina-sobre.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="descricao_principal" 
                              ...
                              required>{{ old('descricao_principal') }}</textarea>
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div>
                    ...
                    <textarea id="missao" 
                              ...
                              rows="4"
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                              placeholder="Qual é a missão da sua empresa?">{{ old('missao') }}</textarea>
                    @error('missao')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea id="visao" 
                              ...
                              rows="4"
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                              placeholder="Qual é a visão da sua empresa?">{{ old('visao') }}</textarea>
                    @error('visao')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea id="valores" 
                              ...
                              rows="4"
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                              placeholder="Quais são os valores da sua empresa?">{{ old('valores') }}</textarea>
                    @error('valores')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="grid md:grid-cols-4 gap-6">
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('equipe_profissionais') }}"
                           min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                           placeholder="25">
