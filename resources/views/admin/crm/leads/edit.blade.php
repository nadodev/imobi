...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">
            <i class="fas fa-user-edit mr-2"></i>Editar Lead
        </h1>
        ...
        <form method="POST" action="{{ route('admin.crm.leads.update', $lead) }}">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="telefone" id="telefone" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('telefone') border-red-500 @enderror" 
                                   value="{{ old('telefone', $lead->telefone) }}" required>
                            @error('telefone')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="observacoes" id="observacoes" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('observacoes') border-red-500 @enderror" 
                                      rows="3">{{ old('observacoes', $lead->observacoes) }}</textarea>
                            @error('observacoes')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select name="origem" id="origem" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('origem') border-red-500 @enderror" required>
                                ...
                                <option value="whatsapp" {{ old('origem', $lead->origem) == 'whatsapp' ? 'selected' : '' }}>WhatsApp</option>
                                <option value="instagram" {{ old('origem', $lead->origem) == 'instagram' ? 'selected' : '' }}>Instagram</option>
                                <option value="facebook" {{ old('origem', $lead->origem) == 'facebook' ? 'selected' : '' }}>Facebook</option>
                        ...
                        <div>
                            ...
                            <select name="status" id="status" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('status') border-red-500 @enderror" required>
                                ...
                                <option value="proposta" {{ old('status', $lead->status) == 'proposta' ? 'selected' : '' }}>Proposta</option>
                                <option value="negociacao" {{ old('status', $lead->status) == 'negociacao' ? 'selected' : '' }}>Negociação</option>
                                <option value="fechado" {{ old('status', $lead->status) == 'fechado' ? 'selected' : '' }}>Fechado</option>
                        ...
                        <div>
                            ...
                            <select name="corretor_id" id="corretor_id" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('corretor_id') border-red-500 @enderror">
                                ...
                                @foreach($corretores as $corretor)
                                    <option value="{{ $corretor->id }}" {{ old('corretor_id', $lead->corretor_id) == $corretor->id ? 'selected' : '' }}>
                                        {{ $corretor->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select name="imovel_id" id="imovel_id" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('imovel_id') border-red-500 @enderror">
                                ...
                                @foreach($imoveis as $imovel)
                                    <option value="{{ $imovel->id }}" {{ old('imovel_id', $lead->imovel_id) == $imovel->id ? 'selected' : '' }}>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select name="tipo_interesse" id="tipo_interesse" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('tipo_interesse') border-red-500 @enderror">
                                <option value="">Selecione</option>
                                <option value="compra" {{ old('tipo_interesse', $lead->tipo_interesse) == 'compra' ? 'selected' : '' }}>Compra</option>
                                <option value="venda" {{ old('tipo_interesse', $lead->tipo_interesse) == 'venda' ? 'selected' : '' }}>Venda</option>
                                <option value="aluguel" {{ old('tipo_interesse', $lead->tipo_interesse) == 'aluguel' ? 'selected' : '' }}>Aluguel</option>
                                <option value="locacao" {{ old('tipo_interesse', $lead->tipo_interesse) == 'locacao' ? 'selected' : '' }}>Locação</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" name="valor_interesse" id="valor_interesse" 
                                   ...
                                   value="{{ old('valor_interesse', $lead->valor_interesse) }}" step="0.01" min="0">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="cidade_interesse" id="cidade_interesse" 
                                   ...
                                   value="{{ old('cidade_interesse', $lead->cidade_interesse) }}">
                        ...
                        <div>
                            ...
                            <input type="text" name="bairro_interesse" id="bairro_interesse" 
                                   ...
                                   value="{{ old('bairro_interesse', $lead->bairro_interesse) }}">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="quartos_interesse" id="quartos_interesse" 
                                       ...
                                       value="{{ old('quartos_interesse', $lead->quartos_interesse) }}" min="0">
                            ...
                            <div>
                                ...
                                <input type="number" name="banheiros_interesse" id="banheiros_interesse" 
                                       ...
                                       value="{{ old('banheiros_interesse', $lead->banheiros_interesse) }}" min="0">
            ...
            <div class="mt-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        <label for="ultimo_contato" class="block text-sm font-medium text-gray-700 mb-1">Último Contato</label>
                        <input type="datetime-local" name="ultimo_contato" id="ultimo_contato" 
                               class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('ultimo_contato') border-red-500 @enderror" 
                               value="{{ old('ultimo_contato', $lead->ultimo_contato ? $lead->ultimo_contato->format('Y-m-d\TH:i') : '') }}">
                        @error('ultimo_contato')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="proximo_followup" id="proximo_followup" 
                               ...
                               value="{{ old('proximo_followup', $lead->proximo_followup ? $lead->proximo_followup->format('Y-m-d\TH:i') : '') }}">
            ...
            <div class="flex space-x-4 mt-8">
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg flex items-center">
                    <i class="fas fa-save mr-2"></i> Atualizar Lead
                </button>
